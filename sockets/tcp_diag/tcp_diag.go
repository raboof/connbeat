...
func pollConnections(family uint8, socket *netlink.NetlinkSocket, socketInfo chan<- *sockets.SocketInfo) error {
...
func pollCurrentConnectionsForFamily(family uint8, socketInfo chan<- *sockets.SocketInfo) error {
